...
BooksManager bm =BooksManager.getBookManager();
		...
		bm.Insert(b);
		JOptionPane.showMessageDialog(null,b.toString() + " successfully Insert","مدیریت کتابخانه",JOptionPane.INFORMATION_MESSAGE);
		this.txtaAllBooks.setText(bm.toString());
	}
